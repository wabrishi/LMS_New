...
export const LoginView: React.FC<LoginViewProps> = ({ onLoginSuccess, onOpenDbSetup }) => {
            ...
            <div className="flex items-center gap-2">
              {onOpenDbSetup && (
                <button
                  ...
                  className="px-2.5 py-1 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg text-[10px] transition shadow-xs"
                >
                  Test / Config DB
                </button>
              )}
